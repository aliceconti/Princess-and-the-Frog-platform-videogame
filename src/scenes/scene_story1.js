export default class Storia1 extends Phaser.Scene {
    ...
    preload(){
        ...
        this.load.image("sfondo1", "assets/UI/HUD/scene/scena1.jpg");
        this.load.image("play_button", "assets/UI/ricomincia.png");
    }

    create(){
        console.log("scene_story_create");

        this.background = this.add.image(0, 0, "sfondo1");
    ...
    update(){
        console.log("scene_story_update");
    }
