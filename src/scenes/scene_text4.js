export default class Text4 extends Phaser.Scene {
    ...
    init(){
        console.log("scene_text4_init");
    }

    preload(){
        console.log("scene_text4_pre");

        this.load.image("home_button", "assets/UI/home.png");
        this.load.image("testo4", "assets/UI/HUD/testi/text4.jpg");
    }

    create(){
        console.log("scene_text4_gameover");

        this.testo = this.add.image(this.game.config.width/2, this.game.config.height/2, "testo4");
