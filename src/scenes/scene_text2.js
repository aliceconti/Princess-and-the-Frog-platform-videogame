export default class Text2 extends Phaser.Scene {
    ...
    init(){
        console.log("scene_text2_init");
    }

    preload(){
        console.log("scene_text2_pre");

        this.load.image("home_button", "assets/UI/home.png");
        this.load.image("testo2", "assets/UI/HUD/testi/text2.jpg");
        this.load.image("play_button", "assets/UI/ricomincia.png");
    }

    create(){
        console.log("scene_text2_gameover");
        
        this.testo = this.add.image(this.game.config.width/2, this.game.config.height/2, "testo2");
